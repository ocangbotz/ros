...
global.ownerNumber = ['628313665-025','6285823828126'] //Ganti Jadi Nomer mu Biar Fitur Ownernya Bisa Dipake
global.Rowner = '628194067160' //Owner Utama
global.ownerName = 'Ocang Store' //Ganti Jadi Namamu
global.packname = 'CoolBotz' //Ganti Jadi Nama Botmu
global.author = 'Fathir anak baik' //Ganti Jadi Namamu
global.prefa = ['','.','#','!'] //Ilangin Prefix Yang '' Kalau Gamau No Prefix
global.sessionName = 'sesi' //Saran Gausah Diganti Lagi
global.webme = 'instagram.com/ocangstore_l' //Ganti Jadi Bebas Web Sosmed Mu
global.sosmed = 'https://www.instagram.com/thrtysix_' //Ganti Jadi Web Sosmed Mu
...
//===> SESUAIKAN DENGAN KEBUTUHAN MU 
global.mess = {
admin: '*Minimal Jadi admin Dek!*',
botAdmin: '*Jadiin Gw Admin Doloe!*',
botOwner: '*Lh Lu Siapa?,Owner Gw Bukan!?*',
group: '*Khusus Group!*',
private: '*Khusus Private Chat!*',
wait: '*Waiting For Proccess....*',
done: '*Done!*',
prem: '*Premium Dulu Dek*'
}
